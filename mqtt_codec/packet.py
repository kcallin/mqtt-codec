...
class MqttPublish(MqttPacketBody):
    ...
    packet_id: int
        ...
        When QoS=0 this attribute will have a value of zero if the
        object was generated by the ``mqtt-codec`` decoder.  With QoS=0
        this property's value is not encoded (in accordance with MQTT
        specification 3.3.1-2).
